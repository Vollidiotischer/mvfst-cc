...
//   header["length"] = lostBytes;   
  ...
  folly::dynamic frame = folly::dynamic::object(); 
  frame["frame_type"] = "stream"; 
  frame["length"] = lostBytes; 
  frame["offset"] = 100; 
  
  folly::dynamic arr = folly::dynamic::array(frame); 

  data["frames"] = arr; 

//   data["packet_size"] = lostBytes;
